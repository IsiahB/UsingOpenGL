...
ObjModel.prototype.render = function(gl, uni) {
    ...
    for(let i = 0; i < this.meshes.length; i++){
        ...
        //get the color from the meshes array
        gl.uniform3fv(uni.uColor, this.meshes[i].color); //set the color
        // draw triangles
    ...
    if( this.triangleData.edgeVao){
        gl.uniform3fv(uni.uColor, Float32Array.from([0,0,0])); //[0,0,0] is black
